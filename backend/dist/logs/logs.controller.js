...
let LogsController = class LogsController {
    ...
    list(q, label, from, to, limit, cursor) {
    ...
    async exportCsv(res, q, label, from, to, limit, cursor) {
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)('admin', 'read'),
...
], LogsController.prototype, "exportCsv", null);
